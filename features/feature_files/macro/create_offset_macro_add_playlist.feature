##language: zh-CN
#@create_dynamic_macro_and_add_playlist
#功能:create_dynamic_macro_and_add_playlist
#
...
#
#    例子:
#      | title         | type          | name      | playlist            |content_title_text|
#      | dynamic_macro | dynamic_macro | titleName | playlist_title_text |content_title_text|